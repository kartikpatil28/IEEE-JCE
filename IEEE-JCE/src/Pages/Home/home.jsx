...
const Home = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      {/* Hero Section */}
      <div className="relative w-full h-[50vh] flex items-center justify-center bg-gradient-to-r from-blue-800 to-purple-800">
        <img
          src={grp}
          alt="IEEE Event"
        ...
        <div className="text-center z-10 px-4">
          ...
          <Link
            to="/about"
            className="mt-6 inline-block bg-white text-blue-800 px-6 py-2 md:px-8 md:py-3 rounded-lg shadow-lg hover:bg-gray-100 hover:scale-105 transition-transform"
          >
            Learn More
          </Link>
        </div>
      ...
      {/* Stats Section */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 py-12 px-4 bg-gradient-to-r from-blue-50 to-purple-50">
          ...
          (stat, i) => (
            <MotionWrapper key={i} delay={i * 0.2}>
              <div className="bg-white p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow">
                <h3 className="text-2xl md:text-3xl font-bold text-blue-800">{stat}</h3>
          ...
          {events.slice(0, showMore ? events.length : 3).map((event, i) => (
            <MotionWrapper key={i}>
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                <h3 className="text-xl md:text-2xl font-bold text-gray-800">{event.name}</h3>
      ...
      {/* Societies Section */}
      <div className="py-12 bg-gradient-to-r from-blue-50 to-purple-50 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">IEEE Societies</h2>
            ...
            <MotionWrapper key={i}>
              <div className="text-center">
                <img
                  ...
                  className="h-20 w-20 md:h-24 md:w-24 rounded-full shadow-lg mx-auto hover:scale-110 transition-transform"
                  loading="lazy"
                />
      ...
      <div className="py-12 bg-white text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Faculty Advisors</h2>
          ...
          {facultyAdvisors.map((advisor, i) => (
            <MotionWrapper key={i}>
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                />
                <h3 className="text-xl md:text-2xl font-bold text-gray-800 mt-4">{advisor.name}</h3>
      ...
      <div className="py-12 bg-gradient-to-r from-blue-50 to-purple-50 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Words of Wisdom</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 px-4">
          {facultyAdvisors.map((advisor, i) => (
            <MotionWrapper key={i}>
              <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-800 mt-4">{advisor.name}</h3>
                <p className="text-gray-600 mt-2">{advisor.role}</p>
                <p className="mt-4 text-sm text-gray-700 italic">"{advisor.quote}"</p>
              </div>
            </MotionWrapper>
          ))}
        </div>
      ...
      {/* Upcoming Events Panel (Mobile Bottom Sheet) */}
      <div className="fixed bottom-0 left-0 right-0 md:hidden">
        <button
          onClick={() => setShowEventsPanel(!showEventsPanel)}
          className="w-full bg-blue-800 text-white p-3 rounded-t-lg shadow-lg hover:bg-blue-900 transition"
          title={showEventsPanel ? "Hide Events" : "Show Events"}
        >
          <FaBell size={20} className="mx-auto" />
        </button>
        {showEventsPanel && (
          <div className="bg-white w-full p-4 rounded-t-lg shadow-lg max-h-[50vh] overflow-y-auto">
      ...
      {/* Upcoming Events Panel (Desktop) */}
      <div className="fixed top-1/2 right-0 transform -translate-y-1/2 hidden md:flex items-center gap-2">
        <button
          onClick={() => setShowEventsPanel(!showEventsPanel)}
