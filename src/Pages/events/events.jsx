...
import tech1 from "../../assets/Events/Technical/Tech_1.jpg";
import aess1 from "../../assets/Events/AESS/AESS_1.jpg";
import ieee1 from "../../assets/Events/IEEE/IEEE_1.jpg";
import cs1 from "../../assets/Events/CS/CS_1.jpg";
      ...
      resolve({
        ...
        pastEvents: [
          ...
          },
          {
            ...
            description: "Comprehensive workshop on technical paper writing and research methodologies, helping students understand the process of writing and publishing research papers.",
            image: tech1,
            highlights: ["Research methodology", "Paper formatting", "Publication guidelines", "Hands-on session"]
          },
          {
            title: "AESS Technical Talk",
            date: "January 20, 2024",
            description: "Expert talk on Aerospace and Electronic Systems, covering recent advancements in aviation technology and electronic warfare systems.",
            image: aess1,
            highlights: ["Industry expert speaker", "Live demonstrations", "Q&A session", "Networking"]
          },
          {
            title: "IEEE Day Celebration",
            date: "October 10, 2023",
            description: "Annual IEEE Day celebration with various technical activities, competitions, and networking events to promote technology and innovation.",
            image: ieee1,
            highlights: ["Technical competitions", "Project showcase", "Awards ceremony", "Cultural events"]
          },
          {
            title: "Coding Workshop Series",
            date: "September 15-20, 2023",
            description: "Six-day intensive coding workshop covering web development, app development, and competitive programming concepts.",
            image: cs1,
            highlights: ["Web development", "App development", "Competitive programming", "Project development"]
          }
        ],
        // Keeping the upcoming events structure as is
        upcomingEvents: [
          {
